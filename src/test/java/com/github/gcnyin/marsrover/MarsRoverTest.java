package com.github.gcnyin.marsrover;
...
public class MarsRoverTest {
  ...
  public void should_turn_direct() {
    ...
    final Direct direct1 = Direct.N;
    final MarsRover.Initialization initialization1 = new MarsRover.Initialization(x1, y1, direct1);
    final MarsRover.TurnRight turnRight1 = new MarsRover.TurnRight();
    marsRover1.tell(new MarsRover.BatchMessage(controlCenter.getRef(), Arrays.asList(initialization1, turnRight1)));
    controlCenter.expectMessage(new MarsRover.Status(x1, y1, Direct.E));
    testKit.stop(marsRover1);
  }
}
